...
public:
    ...
    MapFusion(){
        ...
        _sub_loop_info_global = nh.subscribe<liorf::context_info>(_sc_topic + "/loop_info_global",
                            100, &MapFusion::globalLoopInfoHandler, this, ros::TransportHints().tcpNoDelay());


        if(_robot_id != _robot_initial){
            _sub_scan_context_info = nh.subscribe<liorf::context_info>(_sc_topic + "/context_info",
        ...
        _pub_context_info     = nh.advertise<liorf::context_info> (_sc_topic + "/context_info", 1);
        _pub_loop_info        = nh.advertise<liorf::context_info> (_robot_id + "/" + _sc_topic + "/loop_info", 1);
        ...
        _pub_loop_info_global = nh.advertise<liorf::context_info>(_sc_topic + "/loop_info_global", 1);
...
//        return;
    ...
    void scanContextInfoHandler(const liorf::context_infoConstPtr& msgIn){
